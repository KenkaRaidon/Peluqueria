...
INSERT INTO `cliente_mascotas` VALUES (2,5),(2,18),(2,19),(2,24),(2,33),(2,35),(6,36),(7,11),(9,14),(25,7),(26,12);
...
CREATE TABLE `historial` (
  ...
  CONSTRAINT `historial_ibfk_1` FOREIGN KEY (`id_cita`) REFERENCES `cita` (`id_cita`),
  CONSTRAINT `historial_ibfk_2` FOREIGN KEY (`id_empleado`) REFERENCES `empleado` (`id_empleado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
