<?php include "includes/header.php"; ?>
    ...
    <a class="Logout" href="bd/logout.php">Logout</a>

    <a class="BotonClientes" href="cliente.php">Clientes</a>
    <a class="BotonMascotas" href="mascota.php">Mascotas</a>
    <a class="BotonCitas" href="cita.php">Citas</a>
    <a class="BotonEmpleados" href="empleado.php">Empleados</a>
    <a class="BotonHistorial" href="historial.php">Historial</a>
    <a class="BotonUsuarios" href="usuario.php">Usuarios</a>
            ...
            <g id="Layer_1" data-name="Layer 1">
                <g id="bear">
                    ...
                    <g id="Head" class="head">
                        ...
                        <path id="Head-2" data-name="Head" d="M409.6,176.9c0,94.7-83.5,130.1-186.4,130.1S36.8,271.6,36.8,176.9,120.3,5.4,223.2,5.4,409.6,82.2,409.6,176.9Z" fill="#e07320" />
